        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="d-flex justify-content-center mt-3"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> AJOUTER UNE CATEGORIE </h4></div>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form enctype="multipart/form-data" action="{{ route('createCategorie.store') }}" method="POST">
                        @csrf  
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="livres">Ajouter des Livres</label>
                          <div class="col-sm-10">
                                @foreach($livre as $lv)
