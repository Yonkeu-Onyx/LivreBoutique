                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        ...
                        <div class="card mb-4">
                            ...
                            <!-- Account -->
                            <div class="card-body">
                                <form id="formAccountSettings" action='{{ route("gererUtilisateurs.update", $user->id) }}' method="post"
                                    enctype='multipart/form-data'>
                                    @csrf
                                    @method('PUT')
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        <img src="{{ url('assets/images/' . $user->image) }}" alt="user-avatar"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control" type="text" id="firstName" name="nom" value="{{ old("nom",$user->nom) }}"
                                            autofocus="">
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="password" class="form-control" id="organization" name="motDePasse"
                                            value="{{ old("motDePasse",$user->motDePasse) }}">
                                    </div>
