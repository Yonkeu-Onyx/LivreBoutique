...
>
  <head>
    ...
    <title>Insérer un ouvrage</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Insérer un ouvrage</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <form enctype="multipart/form-data" action="{{ route('createOuvrage.store') }}" method="POST">
                        @csrf  
                        <div class="row mb-3">
